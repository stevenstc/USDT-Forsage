          ...
          <div>
            <section class="widget Widget_widget__32uL4">
              <div class="Widget_widgetControls__B4-0r widget-controls">
                <span>
                  <button id="collapseId-08c297e8-ed01-425e-8d08-93cf64b9410e">
                    <i class="fa fa-angle-down"></i>
                  </button>
                </span>
                <button id="closeId-08c297e8-ed01-425e-8d08-93cf64b9410e">
                  <strong class="text-gray-light"></strong>
                </button>
              </div>
              <div
                aria-hidden="false"
                        ...
                        <section class="widget Widget_widget__32uL4 widget-auth mx-auto pack pack-enable">
                          <header class="Widget_title__1U9X_">
                            <div class="pack-header pack-header-enable">
                              <div class="pack-ind">
                                <span class="badge badge-dark-no-border">
                                  1
                                </span>
                              </div>
                              <div
                            ...
                            <div>
                              <div class="Widget_widgetBody__34soD widget-body">
                                <div class="pack-body">
                                  ...
                                  <div class="mt row">
                                    <span class="badge-left badge badge-blue-light">
                                      <i class="fa fa-users"></i>
                                    </span>
                              ...
                              <div class="Widget_widgetBody__34soD widget-body">
                                <div class="pack-body">
                                  ...
                                  <div class="mt row">
                                    ...
                                    <span class="badge-center badge badge-blue-light">
                                      <i class="fa fa-users"></i>
                                    </span>
                                    <span class="badge-right badge badge-gray">
                                      <i class="fa fa-users"></i>
                            ...
                            <div>
                              <div class="Widget_widgetBody__34soD widget-body">
                                <div class="pack-body">
                                  <div class="mt row"></div>
                                  <div class="mt row">
                                    <p class="badge-center">
                                      <i class="fa fa-shopping-cart"></i>
                                    </p>
                                    <p class="badge-center badge-top">
                                      Activate&nbsp;
                                    </p>
                                  </div>
                                </div>
                      ...
                      <div class="mt row">
                        ...
                        <div class="col-12 col-md-3">
                          <div
                            ...
                            style={{ height: "45px", maxHeight: "45px" }}
                          >
                            <i class="fa fa-users"></i> Number partners in the
                            slot
                          </div>
                        </div>
                      </div>
