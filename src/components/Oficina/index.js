  ...
  async Investors() {
    ...
    for (i = 1; i <= LAST_LEVEL; i++) {
      if (await Utils.contract.usersActiveX3Levels(direccion, i).call()) {
        ...
        //console.log(ganado);
        canasta[i - 1] = (
          <div class="col-12 col-lg-2 col-xl-4" key={"level" + i}>
            <section class="widget Widget_widget__32uL4 widget-auth mx-auto pack pack-enable">
              <header class="Widget_title__1U9X_">
                <div class="pack-header pack-header-enable">
                  <div class="pack-ind">
                    <span class="badge badge-dark-no-border">{i}</span>
                  </div>
                  <div class="text-center mb-sm" style={{ paddingTop: "10px", paddingLeft: "5px", paddingRight: "5px", paddingBottom: "2px"   }}>
              ...
              >
                <div>
                  <div class="Widget_widgetBody__34soD widget-body">
                    <div class="pack-body">
                      <div class="mt row">
                        <span class={"badge-left badge " + estilo1}>
                          <i class="fa fa-users"></i>
                        </span>
                        <span class={"badge-center badge " + estilo2}>
                          <i class="fa fa-users"></i>
                        </span>
                        <span class={"badge-right badge " + estilo3}>
                          <i class="fa fa-users"></i>
                        </span>
                      </div>
                      ...
                      <div class="mt row">
                        ...
                        >
                          <button
                            class="auth-btn btn btn-secondary"
                    ...
                    <footer>
                      <div
                        color="transparent"
                        class="btn-xs float-left py-0"
                        id="load-parthers-btn"
                      >
                        <i class="fa fa-users"></i>{" "}
                        {matrix[1].length + matrix[3] * 3}
                      </div>
                      <div
                        color="transparent"
                        class="btn-xs float-right py-0"
                        id="load-notifications-btn"
                      >
                        <i class="fa fa-refresh"></i> {matrix[3]}
                      </div>
                    </footer>
                  </div>
                </div>
            ...
            <section class="widget Widget_widget__32uL4 widget-auth mx-auto pack pack-enable">
              <header class="Widget_title__1U9X_">
                <div class="pack-header pack-header-enable">
                  ...
                  <div class="text-center mb-sm" style={{ padding: "5px" }}>
                    <h6>
                      ({i}) {20 ** i}
                    </h6>
                  </div>
              ...
              >
                <div>
                  <div class="Widget_widgetBody__34soD widget-body">
                    <div class="pack-body">
                      <div class="mt row">
                        <span class="badge-left badge badge-gray">
                          <i class="fa fa-users"></i>
                        </span>
                        <span class="badge-center badge badge-gray">
                          <i class="fa fa-users"></i>
                        </span>
                        <span class="badge-right badge badge-gray">
                          <i class="fa fa-users"></i>
                        </span>
                      </div>
                      <div class="mt row"></div>
                      ...
                      <div class="mt row">
                        ...
                        >
                          <button
                            class="auth-btn btn btn-success"
                            style={{ color: "white", width: "100%" }}
                          >
                            Buy level
                          </button>
    ...
    return (
      <main class="Layout_content__3Ygen">
        <section class="widget Widget_widget__32uL4">
            <header class="Widget_title__1U9X_ dashboard-header" style={{ padding: "10px" }}>
              <div className="row">
          ...
          >
            <div class="Widget_widgetBody__34soD widget-body">
              <div class="row">{this.state.canastas}</div>
              <footer
                class="text-sm card-footer"
              ...
              >
                <div class="mt row">
                  <div class="col-12 col-md-3">
                    ...
                    >
                      <i class="fa fa-refresh"></i> Recycle count
                    </div>
                  </div>
                  <div class="col-12 col-md-3">
                    <div
                      ...
                      style={{ height: "45px", maxHeight: "45px" }}
                    >
                      <i class="fa fa-users"></i> Number partners in the slot
                    </div>
                  </div>
                </div>
              </footer>
