                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style={{textAlign: 'right'}}>
                                        ...
                                        <p>1 <i class="fa fa-comment text-white"></i></p>
                                ...
                                <div>
                                    <div class="Widget_widgetBody__34soD widget-body">
                                        <form>
                                            ...
                                            <div class="mt form-group"><button type="submit" class="auth-btn btn btn-success btn-sm" style={{color: 'white', width: '100%'}}>Copy referal link</button></div>
